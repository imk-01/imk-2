...
export default function RencanaStrategisDetail() {
  ...
  const documentData = {
    ...
    views: 2847,
    description:
      "Dokumen perencanaan strategis institusi untuk periode 2024-2029 yang mengacu pada Renstra BPS dan RPJMN 2020-2024.",
              ...
              <div className="mt-8">
                <div className="prose prose-lg max-w-none">
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Rencana Strategis Politeknik Statistika STIS 2024-2029
                    disusun sebagai pedoman dalam pencapaian visi dan misi
                    institusi. Dokumen ini mengacu pada Rencana Strategis BPS
                    2020-2024 dan Rencana Pembangunan Jangka Menengah Nasional
                    (RPJMN) 2020-2024.
                  </p>

                  <p className="text-gray-700 leading-relaxed">
                    Rencana strategis ini mencakup empat sasaran utama yang akan
                    menjadi fokus pengembangan institusi dalam lima tahun ke
                    depan, dengan target pencapaian yang terukur dan
                    berkelanjutan.
                  </p>
                </div>
              </div>

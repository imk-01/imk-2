...
export default function PerjanjianKinerjaDetail() {
  ...
  const documentData = {
    ...
    category: "Kontrak",
    description:
      "Dokumen perjanjian kinerja institusi dengan Kementerian Pendidikan, Kebudayaan, Riset dan Teknologi untuk tahun anggaran 2024.",
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <ChevronRight size={16} />
            <span className="text-gray-900">Perjanjian Kinerja</span>
          </div>
        </div>
      </div>
              ...
              <div className="mt-8">
                <div className="prose prose-lg max-w-none">
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Perjanjian Kinerja tahun 2024 ditetapkan dalam dokumen
                    perencanaan untuk mencapai target kinerja jangka menengah
                    Politeknik Statistika STIS. Dokumen ini berisi komitmen
                    institusi dalam pencapaian sasaran strategis yang telah
                    ditetapkan.
                  </p>

                  <p className="text-gray-700 leading-relaxed">
                    Perjanjian ini mengacu pada Rencana Strategis STIS 2020-2024
                    dan sejalan dengan target kinerja Badan Pusat Statistik

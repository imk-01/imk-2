...
export default function MaklumatPelayananDetail() {
  ...
  const documentData = {
    ...
    category: "Pelayanan",
    description:
      "Standar pelayanan publik dan komitmen kualitas layanan STIS kepada seluruh stakeholder termasuk mahasiswa, dosen, dan masyarakat umum.",
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <ChevronRight size={16} />
            <span className="text-gray-900">Maklumat Pelayanan</span>
          </div>
        </div>
      </div>
              ...
              <div className="mt-8">
                <div className="prose prose-lg max-w-none">
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Maklumat Pelayanan Politeknik Statistika STIS merupakan
                    pernyataan kesanggupan dan kewajiban penyelenggara pelayanan
                    untuk melaksanakan pelayanan sesuai dengan standar yang
                    telah ditetapkan. Maklumat ini menjadi komitmen institusi
                    dalam memberikan pelayanan yang berkualitas.
                  </p>

                  <p className="text-gray-700 leading-relaxed mb-6">
                    Dokumen ini berisi standar pelayanan untuk berbagai unit
                    seperti akademik, kemahasiswaan, perpustakaan, keuangan, dan
                    teknologi informasi. Setiap unit memiliki standar waktu,
                    biaya, persyaratan, dan prosedur yang jelas.
                  </p>

                  <p className="text-gray-700 leading-relaxed">
                    Maklumat pelayanan ini merupakan bentuk komitmen STIS dalam
                    memberikan pelayanan prima dan transparansi kepada seluruh
                    stakeholder sesuai dengan prinsip good governance.
                  </p>
                </div>
              </div>
